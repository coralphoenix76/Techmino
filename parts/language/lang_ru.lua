...
loadSFX="Загружаем звуковые эффекты",
    ...
    atkModeName={"Рандом","Значки","Нокауты","Атака"},
    ...
    ai_puzzle="ИИ несовместим с режимом Puzzle gamemode.",
    ai_mission="ИИ несовместим с польз. миссиями.",
    ai_badPiece="ИИ несовместим с пользовательскими последовательностями, содержащими не тетромино.",
