...
return {
    loadText={
        loadSample="Загрузка сэмплов инструментов",
        loadVoice="Загрузка голосовых пакетов",
        loadFont="Загрузка шрифтов",
        loadModeIcon="Загрузка значков режимов",
        loadMode="Загрузка режимов",
        loadOther="Загрузка других ресурсов",
        finish="Нажмите любую клавишу для запуска!",
    },
    sureQuit="Нажмите снова, чтобы выйти",
    sureReset="Нажмите снова, чтобы перезапустить",
    sureDelete="Нажмит снова, чтобы удалить",
    newDay="Новый день, новое начало!",
    playedLong="Вы уже долго играете. Время сделать перерыв!",
    playedTooMuch="Вы уже играете слишком долго! Играть Techmino весело, но не забывайте отдыхать!",
    settingWarn="Осторожно — вы меняете необычные настройки!",
    settingWarn2="Этот параметр вступает в силу после перезапуска",
    
    atkModeName={"Случайный","Значки","Нокауты","Атакующие"},
    ...
    spin="-спин",
    spinNC="-спин",
    clear={"Один", "Двойной", "Тройной", "Техраш", "Пентакраш", "Гексакраш", "Гептакраш", "Октакраш", "Нонакраш", "Декакраш", "Ундекакраш", "Додекакраш", "Тридекакраш", "Тетрадекакраш", "Пентадекакраш", "Гексадекакраш", "Гептадекакраш", "Октадекакраш", "Нонадекакраш", "Ультракраш", "Импоссикраш"},
    cleed="$1 строк",
    ...
    rpm="RPM",tsd="TSD",
    grade="Ранг",techrash="Techrashes",
